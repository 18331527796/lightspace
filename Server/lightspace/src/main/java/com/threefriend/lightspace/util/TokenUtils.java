...
public class TokenUtils {
	...
	private static final int VALID_TIME = 1800; // token有效期(秒)
	...
	public static String getToken(Integer userId) {
		String token = TokenEncryptUtils.encoded(getCurrentTime()+","+userId);
		System.out.println(token+"在这呢");
		return token;
	}
	...
	public static void main(String[] args) {
		...
		// 获取token
		String token = TokenUtils.getToken(2);
