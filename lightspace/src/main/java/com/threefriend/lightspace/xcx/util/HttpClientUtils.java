...
public class HttpClientUtils {
    ...
    public static String sendPostJsonStr(String url, String jsonString) throws IOException {
        ...
        try {
           ...
           System.out.println("发送消息出现了错误");
        } finally {
            if (response != null) {
                try {
                    response.close();
                } catch (Exception e) {
                    System.out.println("HttpClientUtils关闭io流出错");
                }
            }
        }
    ...
    public static String sendPost(String url) throws IOException {
        ...
        try {
        	...
        	System.out.println("HttpClientUtils get请求出错");
        }
        // 4.处理结果，这里将结果返回为字符串
        HttpEntity entity = response.getEntity();
        String result = null;
        try {
        	...
        	System.out.println("HttpClientUtils转换EntityUtils.toString 出错");
        }
        return result;
    }
}
