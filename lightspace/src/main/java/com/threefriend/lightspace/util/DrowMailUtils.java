...
public class DrowMailUtils {
	...
	private static final String words = ""
			...
			"5. 首次先进行裸眼检测，后期可根据孩子自身是否佩戴眼镜的情况，点&"+
			"    击“裸视检测”或“戴镜检测”进行裸视检测或者戴镜检测。&" + 
			"6. 仔细阅读页面上的操作提示进行屏幕校准，（可用尺子为参照物，将&"+ 
			"    上方刻度尺调整到真实大小即2.5厘米）校准完毕后点击“校准完成”。&" + 
			"7. 按照轮播图演示的步骤来给孩子进行视力检测。了解检测步骤后，点&"+ 
			"    击“开始测试”进行右眼视力检测。&" + 
			"8. 结束右眼视力检测后，按照屏幕上的提示，进行左眼视力检测。&" + 
			"9. 完成左眼视力检测后，会跳转到检测结果页面。 至此已完成一次“&"+ 
			"    裸视检测”或者“戴镜检测”。&" + 
			"10. 用户可根据自己的需求在小程序中查看相关功能。&" + 
			" &" + 
