...
@Service
public class SchoolCreateQrcoreServiceImpl implements SchoolCreateQrcoreService{
	...
	@Override
	public synchronized ResultVO download(HttpServletResponse response, Map<String, String> params,HttpSession session) {
		...
		try {
			...
			if(type.equals("student")) {
				...
				ids=student_dao.findBySchoolId(schoolId);
				zipName = school_dao.findById(schoolId).get().getName();
			}
			//生成token
